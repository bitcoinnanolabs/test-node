...
namespace
{
char const * test_private_key_data = "809FDF713AD88CABEE08BB656FE4662FC1C7CCDAFCEDE8F50EFA950661CF63BA";
char const * test_public_key_data = "6999D738D4838B30B5D41AE4186F133577BF6AD46BFB4CEC31389A0DA9299EF8"; // bcb_1bn57iumfyddrpyjtomypckknyefi1fj5s4daixsqj75rfy79yz9txiyauj8
...
char const * test_genesis_data = R"%%%({
	"type": "open",
    "source": "6999D738D4838B30B5D41AE4186F133577BF6AD46BFB4CEC31389A0DA9299EF8",
    "representative": "btco_1testwwfb1wd84txa8q653qj8fdqqxofatzubmp54g6t3pnkm9qrqmop8ne7",
    "account": "btco_1testwwfb1wd84txa8q653qj8fdqqxofatzubmp54g6t3pnkm9qrqmop8ne7",
...
genesis_account (network_a == nano::nano_networks::btco_test_network ? nano_test_account : network_a == nano::nano_networks::btco_beta_network ? nano_beta_account : nano_live_account),
genesis_block (network_a == nano::nano_networks::btco_test_network ? nano_test_genesis : network_a == nano::nano_networks::btco_beta_network ? nano_beta_genesis : nano_live_genesis),
...
burn_account (0)
{
	...
	debug_assert (!error);
	auto epoch_v2_signer (network_a == nano::nano_networks::btco_test_network ? nano_test_account : network_a == nano::nano_networks::btco_beta_network ? nano_beta_account : nano_live_epoch_v2_signer);
...
namespace
{
nano::ledger_constants test_constants (nano::nano_networks::btco_test_network);
}
